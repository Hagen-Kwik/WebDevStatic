...
class review extends Model
{
    ...
    private static $gadgets = [
        ...
        [
            'name' =>  'Printer',
            'description' =>  'Masalah yang umum di printer adalah hasil cetakan jelek, roler kertas tidak berfungsi nornal sehingga kertas tidak tertarik. Printer juga dapat mati total yaitu printernya tidak mau nyala apapun usaha kita untuk menyalakan dia dll. Masalah masalah di atas merupakan masalah dari partnya
